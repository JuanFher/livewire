...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="index.html"><img alt="logo" src="{{ asset('images/syslogo.png') }}"> <span class="navbar-brand-name">SysParking</span></a>
            </div>
    ...
    <div class="main-container" id="container">
        ...
        <!--  BEGIN TOPBAR  -->
        <d-iv class="topbar-nav header navbar" role="banner">
            <nav id="topbar">
                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    ...
                    <li class="menu single-menu ">
                        ...
                        <ul class="collapse submenu list-unstyled" id="dashboard" data-parent="#topAccordion">
                            <li>
                                <a href="{{url('dashboard')}}"> ESTADÍSTICOS </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="page"  data-parent="#topAccordion">
                            ...
                            <li>
                             ...
                             <li>
                                <a href="pages_contact_us.html"> COTIZACIONES </a>
                            </li>
                            <li>
                                <a href="pages_faq.html"> RENTAS PRÓXIMAS</a>
                            </li>
